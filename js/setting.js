...
function slide() {
  ...
  switch(random) {
    ...
    case 1:
      ...
      $(function(){
        $('#login-wrap').css('background-image', "url(../images/natu4.jpg)");
      });
      break;
    case 2:
      // 秋
      ...
      $(function(){
        $('#login-wrap').css('background-image', "url(../images/login.jpg)");
      });
      break;
    case 3:
      // 冬
      ...
      $(function(){
        $('#login-wrap').css('background-image', "url(../images/huyu.jpg)");
      });
      break;
  }
  // var tmp = random;
